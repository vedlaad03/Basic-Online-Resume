...
const getUserInputs = () => {
    ...
    eduMarks= document.querySelectorAll('.edu_marks'),
    ...
    eduMarks.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'Percentage/CGPA')));
    ...
    return {
        ...
        educations: fetchValues(['edu_school', 'edu_degree','edu_marks', 'edu_city', 'edu_start_date', 'edu_graduation_date', 'edu_description'], eduSchoolElem, eduDegreeElem,eduMarks, eduCityElem, eduStartDateElem, eduGraduationDateElem, eduDescriptionElem),
